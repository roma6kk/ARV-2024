...
namespace GRB	// грамматика Грейбах
{
    Greibach greibach(NS('S'), TS('$'), 16,
        ...
        Rule(NS('R'), GRB_ERROR_SERIES + 7, 5,					// Ошибка при констуировании условного выражения	
        ...
        Rule(NS('Y'), GRB_ERROR_SERIES + 8, 1,					// Ошибка в теле условного выражения			
        ...
        Rule(NS('W'), GRB_ERROR_SERIES + 13, 9,					// Ошибка в арифметичском выражении
            Rule::Chain(1, TS('i')),
            Rule::Chain(1, TS('l')),
        ...
        Rule(NS('X'), GRB_ERROR_SERIES + 15, 8,				// Недопустимая синтаксическая конструкция в теле условного выражения	
