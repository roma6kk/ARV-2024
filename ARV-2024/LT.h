...
#define	LEX_OR			 '*'	// логическое ИЛИ
#define LEX_AND			 '&'	// логическое И
#define LEX_NOT			 '!'    // логическое НЕ

#define LEX_MOD			 '%'	// остаток
#define	LEX_EQUAL		 '='	// присваивание				
#define LEX_CONDITION	 '?'	// condition:
#define LEX_DIEZ		 '#'	// разделитель блоков усл.выражения
#define	LEX_LITERAL_NUMO 'q'    // шестнадцетеричный литерал
#define LEX_ISTRUE		 'w'	// истинный блок
#define LEX_ISFALSE		 'r'	// ложный блок
...
#define LEX_EQUALS		 'g'	// проверка на равенство
#define LEX_NOTEQUALS	 'h'	// проверка на неравенство
